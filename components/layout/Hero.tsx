...
const cybersigilImages = [
  { src: '/images/symbols/sigil-1.png', position: 'top-20 left-10', size: 350, rotate: 0, delay: 0 },
  { src: '/images/symbols/sigil-2.png', position: 'top-32 right-20', size: 300, rotate: 15, delay: 2 },
  { src: '/images/symbols/sigil-3.png', position: 'bottom-40 left-20', size: 400, rotate: -10, delay: 4 },
  { src: '/images/symbols/sigil-4.png', position: 'bottom-20 right-10', size: 320, rotate: 5, delay: 1 },
  { src: '/images/symbols/sigil-5.png', position: 'top-1/2 left-5', size: 250, rotate: -20, delay: 3 },
  { src: '/images/symbols/sigil-6.png', position: 'top-1/3 right-5', size: 280, rotate: 10, delay: 5 },
]
