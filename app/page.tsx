  ...
  return (
    <main className="min-h-screen bg-cb-black">
      ...
      <section className="py-24 bg-cb-void relative">
        {/* Section Divider Top */}
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-cb-purple to-transparent shadow-[0_0_10px_#6b21a8]" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="font-[family-name:var(--font-space)] text-3xl sm:text-4xl font-black uppercase tracking-tighter mb-4">
              FEATURED <span className="text-cb-purple glow-purple">ARTISTS</span>
            </h2>
            ...
            {[1, 2, 3].map((i) => (
              <div
                ...
                className="group relative aspect-[3/4] bg-cb-black border border-cb-concrete overflow-hidden 
                         hover:border-cb-purple transition-all duration-300"
              ...
              >
                ...
                {/* Corner Accents */}
                <div className="absolute top-0 left-0 w-8 h-8 border-l-2 border-t-2 border-cb-concrete group-hover:border-cb-purple transition-colors" />
                <div className="absolute top-0 right-0 w-8 h-8 border-r-2 border-t-2 border-cb-concrete group-hover:border-cb-purple transition-colors" />
                <div className="absolute bottom-0 left-0 w-8 h-8 border-l-2 border-b-2 border-cb-concrete group-hover:border-cb-purple transition-colors" />
                <div className="absolute bottom-0 right-0 w-8 h-8 border-r-2 border-b-2 border-cb-concrete group-hover:border-cb-purple transition-colors" />
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6">
                  <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                    <div className="text-cb-purple text-xs uppercase tracking-widest mb-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      // HARD TECHNO
                    </div>
                    <h3 className="font-[family-name:var(--font-space)] text-2xl font-black uppercase tracking-tighter text-cb-white mb-1 
                                 group-hover:glow-purple transition-all">
                      ARTIST {i}
                    </h3>
                    <p className="text-cb-muted text-sm mb-4 font-mono">145-160 BPM</p>
                    <button className="text-xs text-cb-purple uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-all 
                ...
                {/* Purple Accent Line */}
                <div className="absolute bottom-0 left-0 right-0 h-1 bg-cb-purple transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 
                              shadow-[0_0_20px_#6b21a8]" />
              </div>
            ))}
          </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="font-[family-name:var(--font-space)] text-3xl sm:text-5xl font-black uppercase tracking-tighter mb-6">
              PRESS & <span className="text-cb-purple glow-purple">PROMOTERS</span>
            </h2>
      ...
      <section className="py-24 bg-cb-void relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-12">
            <div>
              <div className="inline-flex items-center gap-2 text-cb-purple text-xs uppercase tracking-[0.3em] mb-2">
                <Radio className="w-4 h-4" />
                <span>TRANSMISSIONS</span>
              </div>
              <h2 className="font-[family-name:var(--font-space)] text-3xl font-black uppercase tracking-tighter">
                LATEST <span className="text-cb-purple glow-purple">NEWS</span>
              </h2>
            </div>
            <a href="/news" className="text-cb-muted hover:text-cb-purple transition-colors text-sm uppercase tracking-widest hidden sm:block">
              VIEW ALL //
            </a>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[1, 2, 3].map((i) => (
              <article
                key={i}
                className="group bg-cb-black border border-cb-concrete hover:border-cb-purple transition-all duration-300"
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-cb-purple text-xs font-bold uppercase tracking-wider">
                  ...
                  <h3 className="font-[family-name:var(--font-space)] text-lg font-bold uppercase tracking-tight text-cb-white 
                               group-hover:text-cb-purple transition-colors mb-2">
                    NEWS TITLE {i}
                  </h3>
                  <p className="text-cb-muted text-sm mb-4 line-clamp-2">
                    Brief description of the news item goes here with some details...
                  </p>
                  <span className="text-cb-purple text-xs uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity 
      ...
      <section className="py-24 bg-cb-black relative">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="font-[family-name:var(--font-space)] text-4xl sm:text-6xl font-black uppercase tracking-tighter mb-6">
            READY TO <span className="text-cb-purple glow-purple">BOOK?</span>
          </h2>
